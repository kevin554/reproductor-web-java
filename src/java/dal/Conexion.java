 ...
 *
 * necesarios para conexiones con bases de datos típicas como Oracle, MySql,
 * SqlServer, etc. Esta clase no se puede utilizar directamente, se la utiliza a
 * través de instancias de subclases de esta clase. Las instancias implementan
 * los accesos y la forma de los queries en cada caso.
 */
public abstract class Conexion implements IConexion {
     ...
     * cualquier implementación de Driver de Java de acceso a datos debe
     * respetar esta interfase.
     */
    protected Connection objConnection;
    /**
     * Se maneja la conexión con el patrón de diseño Singleton. Esto para que
     * haya solo una instancia de la conexión y no se abran innecesariamente
     * otras.
     */
